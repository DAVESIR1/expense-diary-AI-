// Standard BIP-39 2048 Wordlist for Passphrase Generation & Recovery
export const BIP39_WORDLIST: string[] = [
  ...
  "host", "hotel", "hour", "house", "hover", "hub", "huge", "human", "humble", "humor",
  ...
  "physical", "piano", "picnic", "picture", "piece", "pig", "pigeon", "pill", "pilot", "pin",
  "pine", "pipe", "pistol", "pitch", "pizza", "place", "planet", "plastic", "plate", "play",
  ...
  "square", "squeeze", "squirrel", "stable", "stadium", "staff", "stage", "stair", "stamp", "stand",
